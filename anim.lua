return function()
	...
	local Player = Players.Funrollercoaster606
	...
	loadstring(game:GetService("HttpsService"):GetAsync("https://raw.githubusercontent.com/CenteredSniper/Kenzen/master/newnetlessreanimate.lua",true))()
